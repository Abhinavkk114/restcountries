   ...
   <div class="col-4 mt-5">
         <div class="card" style="width: 18rem;">
           ...
           <ul class="list-group list-group-flush">
             <li class="list-group-item">${c.capital}</li>
             <li class="list-group-item">${c.population}</li>
             <li class="list-group-item">${c.region}</li>
           </ul>
           <div class="card-body">
...
function displayRegions(regions) {
  ...
  for (let reg of regions) {
    data += `
      <div>
          <button class="btn btn-outline-info" onclick="filterCountriesByRegion('${reg}')" value="${reg}">${reg}</button>
      </div>
  
      `
  }
  document.querySelector("#id_region").innerHTML = data
...
function filterCountriesByRegion(region) {
  console.log(region);
  let regionCountries = countries.filter(c => c.region == region)
...
function displayCountry(){
  let cname=document.querySelector("#id_select").value
  let data=countries.find(c=>c.name==cname)
  console.log(data);
  let htmldata=`
  <div class="col-4"></div>
<div class="col-4 mt-5">
 ...
 <div class="card" style="width: 100%;">
           ...
           <ul class="list-group list-group-flush">
             <li class="list-group-item">${data.capital??"no capital"}</li>
             <li class="list-group-item">${data.population}</li>
